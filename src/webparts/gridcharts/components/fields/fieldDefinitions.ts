...
export function buildFormFields(parentProps:IGridchartsProps , parentState: IGridchartsState ){
...
export function buildProjectFormFields(parentProps:IGridchartsProps , parentState: IGridchartsState ){
